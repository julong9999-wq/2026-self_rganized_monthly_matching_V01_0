...
const PortfolioView: React.FC<Props> = ({ portfolio, onUpdateTransaction, onDeleteTransaction, onAddTransaction }) => {
  ...
  const analysisData = useMemo(() => {
    ...
    dailyPerformanceList.sort((a, b) => Math.abs(b.changeValue) - Math.abs(a.changeValue)); // Sort by impact
    ...
    return {
        ...
        dailyPerformanceList, // Added
        totalCurrentMonthIncome,
        totalDailyChangeValue, // Added
        growthCurveNoDiv,
        growthCurveWithDiv,
        maxDivBar,
        maxY,
